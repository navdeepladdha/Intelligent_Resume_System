...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/navdeepladdha' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/navdeep-laddha-038704249/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Navdeep Laddha </b>
                </a>
            </p>
    ...
    st.session_state.form_data['skills_categories']['tools']),
        ...
        if st.button("Generate Resume 📄", type="primary", key="generate_resume_builder"):
     ...
     "124852522.jpeg")
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About AI Resume Analyzer</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://raw.githubusercontent.com/navdeepladdha/ai-resume-analyzer/refs/heads/main/assets/124852522.jpeg?token=GHSAT0AAAAAADOVGAIKJ2ZNQOR32WFE6TTS2JFKZOA'}"
                     alt="Navdeep Laddha"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://raw.githubusercontent.com/navdeepladdha/ai-resume-analyzer/refs/heads/main/assets/124852522.jpeg?token=GHSAT0AAAAAADOVGAIKJ2ZNQOR32WFE6TTS2JFKZOA';">
                <h2 class="profile-name">Navdeep Laddha </h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/navdeepladdha" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/navdeep-laddha-038704249/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:navdeepladdha75@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Full Stack Developer with expertise in AI and Machine Learning.
                    I created AI Resume Analyzer to revolutionize how job seekers approach their career journey.
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "AI Resume Analyzer represents my vision of democratizing career advancement through technology.
